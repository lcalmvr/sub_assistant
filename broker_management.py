...
======================
Dedicated page for managing broker information and contacts
"""
...
st.set_page_config(page_title="Broker Management", layout="wide")
...
def main():
    ...
    with nav_col1:
        if st.button("📂 View Submissions", help="Go to submission management page"):
            st.write("🔗 Run: `streamlit run viewer_with_modular_rating.py --server.port 8501`")
